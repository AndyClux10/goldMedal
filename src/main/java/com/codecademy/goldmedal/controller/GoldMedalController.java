...
public class GoldMedalController{
    ...
    private CountryDetailsResponse getCountryDetailsResponse(String countryName) {
        ...
        var winterWins = this.goldMedalRepository.getByCountryAndSeasonOrderByYearAsc(countryName, "Winter");// TODO: get the collection of wins at the Summer Olympics, sorted by year in ascending order
